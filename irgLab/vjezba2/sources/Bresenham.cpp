...
void Bresenham::draw_suther_line(Grafika& graphics, int xs, int ys, int xe, int ye, glm::vec3& col) {
	int y_max = 0.75 * height;
	int y_min = 0.25 * height;
	int x_min = 0.25 * width;
	int x_max = 0.75 * width;
...
glm::vec2 Bresenham::intersect_with_y(double coeff, int xs, int ys, int y) {
...
glm::vec2 Bresenham::intersect_with_x(double coeff, int xs, int ys, int x) {
